              ...
              <div class="input-group input-group-round">
                ...
                <div class="input-group-append">
                  <button class="btn btn-primary" type="submit">
                    <span>Subscribe</span><i class="icon-long-arrow-right" />
                  </button>
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-3">
            <div class="widget widget-about">
              <img src="/1%20(1).jpg" class="footer-logo" alt="Footer Logo" width="105" height="25">
              <p>
                📌 Buy | Sell | Swap <br>
                ® RC: 3542079 <br>
                📰 Tech News and Rumors <br>
                🚚 Nationwide Delivery <br>
                💷 We accept BTC/USDT payments
              </p>

              <div class="widget-call">
                <i class="icon-phone" />
                Got Question? Call us 24/7
                <a href="tel:08127821234">Call/WhatsApp: 08127821234</a>
              </div><!-- End .widget-call -->
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="widget">
              ...
              <ul class="widget-list">
                ...
                <li><a href="#">How to shop on Servicehub</a></li>
                <li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="footer-copyright">
          Copyright © 2022 ServiceHub. All Rights Reserved.
