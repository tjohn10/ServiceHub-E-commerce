            ...
            <div class="col-lg-9">
              <div class="toolbox">
                <div class="toolbox-left">
                  <div class="toolbox-info">
                    Showing {{ perPage }} of <span>{{ accessories.length }}</span> Products
              ...
              <div class="products mb-3">
                <div class="row justify-content-center">
                  <div v-for="product in accessories.slice((currentPage-1)*perPage,(currentPage-1)*perPage+perPage)" :key="product.id" class="col-6">
                        ...
                        <div class="filter-item">
                          <div class="custom-control custom-checkbox">
                            <nuxt-link to="/shop/accessories">
                              <label class="custom-control-label">Airpods</label>
                            </nuxt-link>
                          </div><!-- End .custom-checkbox -->
                        </div><!-- End .filter-item -->
...
export default {
  ...
  async mounted () {
    try {
      // const response = await this.$strapi.$categories.find({ populate: '*' })
      const response = await this.$axios.get('https://servicehub-strapi.herokuapp.com/api/products?populate=*&filters[name][$startsWith]=Air&filters[name][$startsWith]=5&filters[name][$startsWith]=20')
