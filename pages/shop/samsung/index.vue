            ...
            <div class="col-lg-9">
              <div class="toolbox">
                <div class="toolbox-left">
                  <div class="toolbox-info">
                    Showing {{ perPage }} of <span>{{ samsung.length }}</span> Products
              ...
              <div class="products mb-3">
                <div class="row justify-content-center">
                  <div v-for="product in samsung.slice((currentPage-1)*perPage,(currentPage-1)*perPage+perPage)" :key="product.id" class="col-6">
...
export default {
  ...
  computed: {
    rows () {
      return this.samsung.length
    }
  },
  async mounted () {
    try {
      const response = await this.$axios.get('https://servicehub-strapi.herokuapp.com/api/products?populate=*&filters[name][$startsWith]=Samsung')
      this.samsung = response.data.data
    } catch (e) {
      this.error = e
    }
  },
