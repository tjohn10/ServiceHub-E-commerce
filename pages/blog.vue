          ...
          <div class="row">
            <div class="col-md-8">
              <article v-for="blog in blogs" :key="blog.id" class="entry">
                <figure class="entry-media" style="width: 100%;">
                  <a href="#">
                    <img :src="blog.attributes.image.data.attributes.url" alt="image desc">
                  </a>
                ...
                <div class="entry-body">
                  <div class="entry-meta">
                    <span class="entry-author">
                      by <a href="#">{{ blog.attributes.written_by }}</a>
                    </span>
                    <span class="meta-separator">|</span>
                    <a href="#">{{ blog.attributes.createdAt }}</a>
                    <span class="meta-separator">|</span>
                    <a href="#">2 Comments</a>
                  </div><!-- End .entry-meta -->
...
export default {
  ...
  async mounted () {
    try {
      const response = await this.$axios.get('http://localhost:1337/api/blogs?populate=*')
