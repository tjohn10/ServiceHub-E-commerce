        ...
        <div class="container">
          <div class="row">
            ...
            <aside class="col-lg-3">
                ...
                <table class="table table-summary">
                  <tbody>
                    ...
                    <tr class="summary-shipping-row">
                      <td>
                        <div class="custom-control custom-radio">
                          <input id="standart-shipping" type="radio" name="shipping" class="custom-control-input">
              ...
              <a href="category.html" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE SHOPPING</span><i class="icon-refresh" /></a>
            </aside><!-- End .col-lg-3 -->
          </div><!-- End .row -->
        </div><!-- End .container -->
      </div><!-- End .cart -->
